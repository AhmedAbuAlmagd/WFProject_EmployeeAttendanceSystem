...
namespace EmployeeAttendanceSystem.DataAccess.Migrations
{
    ...
    [Migration("20250311205510_DropAndRecreateLeaveRequest")]
    partial class DropAndRecreateLeaveRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmployeeAttendanceSystem.DataAccess.Models.Attendance", b =>
                {
                    ...
                    b.Property<string>("IsEarlyDeparture")
                        .IsRequired()
                    ...
                    b.Property<int?>("WorkingHours")
                        ...
                        .HasColumnType("int")
                        .HasComputedColumnSql("DATEDIFF(SECOND, CAST(checkInTime AS DATETIME), CAST(checkOutTime AS DATETIME)) / 3600", true);
            ...
            modelBuilder.Entity("EmployeeAttendanceSystem.DataAccess.Models.Log", b =>
                {
                    ...
                    b.Property<int?>("attendance_Status")
                        .HasColumnType("int");
